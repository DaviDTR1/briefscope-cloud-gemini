...
All notable changes to **BriefScope CLOUD Gemini** are documented in this file.
...
- Settings UI to enter the Google API key and tune RAG / history parameters;
...
- This variant fixes both the embedding provider and the LLM to **Google
  Gemini** and requires a Google API key. It makes outbound requests to the
  Google Gemini API.
