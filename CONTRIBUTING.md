# Contributing to BriefScope CLOUD Gemini
...
1. Read the [README](README.md) to understand the architecture (FastAPI
   backend + React frontend, ChromaDB vector store, Google Gemini provider).
...
container logs (`docker logs briefscope_cloud_gemini_service`).
...
export ROOT_PATH=/api/briefscope_cloud_gemini
export LLM_MODE=cloud
uvicorn app.main:app --reload --port 8080
# Health: http://localhost:8080/api/briefscope_cloud_gemini/health
```
