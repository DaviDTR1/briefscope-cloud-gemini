"""
Persistent configuration for BriefScope CLOUD (Google Gemini variant).
...
CHROMA_HOST   = "briefscope_chroma_gemini"
CHROMA_PORT   = 8000
...
# Embedding backend is FIXED to this variant's provider (Google Gemini). The LLM provider
...
_DEFAULTS: dict[str, Any] = {
    "llm_mode":              "cloud",
    # LLM provider is LOCKED to this variant's provider (Google Gemini). See _load().
    "cloud_provider":        "google",
    "cloud_model":           "gemini-1.5-flash",
    "anthropic_api_key":     "",
    "openai_api_key":        "",
    "google_api_key":        "",
    # Embeddings — FIXED to this variant's provider (Google Gemini). Model is editable.
